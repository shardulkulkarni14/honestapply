...
echo "=========== india run done — $(sqlite3 data/honestapply.db "select count(*) from applications where mode='real' and status='applied' and applied_at >= datetime('now','-24 hours');")real in 24h ==========="
